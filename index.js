...
(async () => {
    const DIR = {
        email: 'gerald.tafireyi@shirley.school.nz',  // replace YOUR EMAIL with your email for auto login (keep everything else the same)
        password: 'd5schidia',  // replace YOUR PASSWORD with your password for auto login
